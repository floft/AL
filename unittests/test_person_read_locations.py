...
class PersonReadLocationsTest(TestCase):
    ...
    def test_readlocations_normaldata(self):
        ...
        # on that point
        expected_latitude_list = [40.0, 40.0, 40.0, 40.0, 40.0, 40.0, 40.0, 40.0, 40.0, 40.0, 40.0,
                                  57.1, 57.1, 57.1, 57.1, -2.2, 40.0, 40.0, 11.0, 11.0, 11.0, 11.0,
                                  40.0, 40.0, 40.0, 40.0]
        expected_longitude_list = [-117.0, -117.0, -117.0, -117.0, -117.0, -117.0, -117.0, -117.0,
                                   -117.0, -117.0, -117.0, -131.2, -131.2, -131.2, -131.2, -3.7,
                                   -117.0, -1000.0, -11.0, -11.0, -11.0, -11.0, -117.0, -117.0,
                                   -117.0, -117.0]
        expected_altitude_list = [748.360107421875, 748.360107421875, 748.360107421875,
